...
class Model_RefAttrMapperType(Model_RefMaster):
    __mapper_args__ = {"polymorphic_identity": "attr_type_code"}
...
class Model_RefCensusStrategy(Model_RefMaster):
    __mapper_args__ = {"polymorphic_identity": "census_strategy"}


class Model_RefComparisonOperator(Model_RefMaster):
    __mapper_args__ = {"polymorphic_identity": "comparison_operator"}
...
class Model_RefDataTypes(Model_RefMaster):
    __mapper_args__ = {"polymorphic_identity": "data_type"}


class Model_RefFactorType(Model_RefMaster):
    __mapper_args__ = {"polymorphic_identity": "factor_type"}


class Model_RefInputTypes(Model_RefMaster):
    __mapper_args__ = {"polymorphic_identity": "input_type"}
...
class Model_RefProductVariation(Model_RefMaster):
    __mapper_args__ = {"polymorphic_identity": "product_variation"}


class Model_RefProvision(Model_RefMaster):
    __mapper_args__ = {"polymorphic_identity": "provision"}


class Model_RefRateFrequency(Model_RefMaster):
    __mapper_args__ = {"polymorphic_identity": "rate_frequency"}


class Model_RefRatingStrategy(Model_RefMaster):
    __mapper_args__ = {"polymorphic_identity": "rating_strategy"}


class Model_RefUnitCode(Model_RefMaster):
    __mapper_args__ = {"polymorphic_identity": "unit_code"}
