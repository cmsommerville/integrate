...
from ..models import Model_ConfigBenefitDurationDetail, Model_ConfigBenefitDurationDetailAuth_ACL
...
class Schema_ConfigBenefitDurationDetail(BaseSchema):
    ...
    acl = ma.Nested(Schema_ConfigBenefitDurationDetail_ACL, many=True)