...
ns_crud.add_resource(CRUD_ConfigAttributeSet, '/crud/config/attribute-set/<int:id>', '/crud/config/attribute-set')
...
ns_crud.add_resource(CRUD_ConfigAttributeSet_List, '/crud/config/attribute-set-list')
...
ns_crud.add_resource(CRUD_ConfigBenefitCovarianceDetail, '/crud/config/benefit/<int:id>', '/crud/config/benefit-covariance-detail')
ns_crud.add_resource(CRUD_ConfigBenefitCovarianceDetail_List, '/crud/config/benefit-covariance-detail-list')
ns_crud.add_resource(CRUD_ConfigBenefitCovarianceSet, '/crud/config/benefit/<int:id>', '/crud/config/benefit-covariance-set')
ns_crud.add_resource(CRUD_ConfigBenefitCovarianceSet_List, '/crud/config/benefit-covariance-set-list')
...
ns_crud.add_resource(CRUD_ConfigRateGroupFaceAmounts_List, '/crud/config/rate-group-face-amounts-list')
...
ns_crud.add_resource(CRUD_RefOptionality, '/crud/ref/optionality/<int:id>', '/crud/ref/optionality')
ns_crud.add_resource(CRUD_RefOptionality_List, '/crud/ref/optionality-list')
