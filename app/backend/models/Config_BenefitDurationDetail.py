...
CONFIG_BENEFIT_DURATION_DETAIL_AUTH_ACL =  TBL_NAMES['CONFIG_BENEFIT_DURATION_DETAIL_AUTH_ACL']
...
class Model_ConfigBenefitDurationDetailAuth_ACL(BaseModel, BaseRowLevelSecurityTable):
    ...
    config_benefit_duration_detail_id = db.Column(db.ForeignKey(
...
class Model_ConfigBenefitDurationDetail(BaseModel):
    ...
    acl = db.relationship("Model_ConfigBenefitDurationDetailAuth_ACL", 
