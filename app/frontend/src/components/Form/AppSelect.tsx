...
const AppSelect = ({ options, selected, ...props }: IProps) => {
  const [selection, setSelection] = useState<IAppSelectOption>();
  ...
  return (
    <div>
      <Listbox value={selection} onChange={_onChange}>
        {({ open }) => (
          <>
